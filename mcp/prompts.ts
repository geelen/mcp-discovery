export interface TestPrompt {
  prompt: string;
  servers: string[];
  expectations: Array<(answer: string) => boolean>;
}
...
export const prompts: TestPrompt[] = [
  {
    ...
    servers: ["ppt"],
    expectations: [
      (answer) => answer.includes("1"),
      (answer) => answer.includes("What are Agents?")
    ]
  },
  {
  ...
  },
  {
    ...
    servers: ["ppt"],
    expectations: [
      (answer) => answer.includes("Common Frameworks for Agents")
    ]
  },
  {
    ...
    servers: ["playwright"],
    expectations: [
      (answer) => answer.includes("Example Domain")
    ]
  },
  {
    ...
    expectations: [
      ...
      (answer) => !answer.toLowerCase().includes("error"),
      (answer) => !answer.toLowerCase().includes("failed")
    ]
  },
  {
  ...
  },
  {
    ...
    expectations: [
      (answer) => /\b(yes|no)\b/i.test(answer)
    ]
  },
  {
    ...
    expectations: [
      (answer) => answer.toLowerCase().includes("slides:"),
      (answer) => answer.toLowerCase().includes("paragraphs:"),
      (answer) => answer.includes("10")
    ]
  },
  {
  ...
  },
  {
    ...
    servers: ["playwright"],
    expectations: [
      (answer) => answer.includes("Herman"),
      (answer) => answer.includes("Melville")
    ]
  },
  {
    ...
    expectations: [
      (answer) => /\d+/.test(answer),
      (answer) => !answer.includes("0") || answer.match(/[1-9]/)
    ]
  },
  {
    ...
    expectations: [
      ...
      (answer) => answer.toLowerCase().includes("domain")
    ]
  },
  {
